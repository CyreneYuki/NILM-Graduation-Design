...
def prompt_learn_load_data(data_path, window_len, house_select, applist, app=None, batch_size=32, sample_rate=16, shuffle=False):
    ...
    if app is None:
        ...
        app_data = data_frame[app].to_numpy(np.float32)
        app_onoff_data = data_onoff_frame[app].to_numpy(np.float32)
