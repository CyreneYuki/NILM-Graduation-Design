...
class AggDecoder(nn.Module):
    ...
    def forward(self, embed):
        ...
        decoded2 = self.Decoder_2(decoded1)
        decoded3 = self.Decoder_3(decoded2)
        decoded4 = self.Decoder_4(decoded3)
        decoded5 = self.Decoder_5(decoded4)
        decoded6 = self.Decoder_6(decoded5)

        out = self.last_conv(decoded6)
        out = out.squeeze(1)
